...
- **Root-level repository filenames must be fully uppercase, including filename extensions, unless a concrete external/tooling requirement makes that impossible.**
