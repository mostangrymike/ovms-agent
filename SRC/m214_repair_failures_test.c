...
int main(void)
{
     ...
     */
    add_run(0x10000001UL, 1, OPENAI_ROLLBACK_NONE, "committed");
    add_run(0x20000002UL, 2, OPENAI_ROLLBACK_SUCCEEDED, "rolled_back");
    add_run(0x30000003UL, 1, OPENAI_ROLLBACK_NONE, "committed");
    add_run(0x40000004UL, 2, OPENAI_ROLLBACK_SUCCEEDED, "rolled_back");
    add_run(0x50000005UL, 1, OPENAI_ROLLBACK_NONE, "committed");
    add_run(0x60000006UL, 2, OPENAI_ROLLBACK_SUCCEEDED, "unsafe");
    add_run(0x70000007UL, 2, OPENAI_ROLLBACK_SUCCEEDED, "rolled_back");
