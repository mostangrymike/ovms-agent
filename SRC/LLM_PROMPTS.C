...
static const char prompt_write[] =
        ...
        "edit an existing file through replace_text or replace_lines, and you "
        "may create a new text file through create_file when the requested "
        "project file does not exist. Never use create_file to overwrite an "
        "existing file. Use replace_lines when an exact inclusive line range is "
        "known, and use replace_text when an exact unique text block is safer. "
        ...
        "it unless the requested text was not present. Before calling "
        ...
        "For existing-file editing, make one smallest possible patch and do not "
