...
{
    (void)state;
    llm_show_repair_plan(arguments);
}
...
{
    (void)state;
    llm_export_repair_history(arguments);
}
...
{
    (void)state;
    llm_show_query_outcome(arguments);
}
...
{
    (void)state;
    llm_show_query_attempts(arguments);
}
...
{
    (void)state;
    llm_show_query_since(arguments);
}
