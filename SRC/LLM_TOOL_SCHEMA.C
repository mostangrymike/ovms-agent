...
static int schema_read_tools(FILE *file)
{
    return fputs(
        ...
        "\"description\":\"Read one project-relative text file; optional start_line and end_line request an inclusive range and must be supplied together.\","
        "\"parameters\":{\"type\":\"object\",\"properties\":{\"path\":{\"type\":\"string\"},"
        "\"start_line\":{\"type\":\"integer\",\"minimum\":1},"
        "\"end_line\":{\"type\":\"integer\",\"minimum\":1}},"
        "\"required\":[\"path\"],\"additionalProperties\":false},\"strict\":false},"
...
static int schema_build_source_tool(FILE *file)
{
    return fputs(
        ...
        "\"description\":\"Build or execute one project-relative source using the validated native toolchain profile selected by source extension. Compiled profiles compile then link; interpreted profiles execute the configured interpreter command once. Execution requires full approval, guarded writes, and DCL execution.\","
